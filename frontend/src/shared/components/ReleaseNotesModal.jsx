...
const RELEASES = [
  {
    ...
    changes: [
      ...
      { type: 'new',      text: 'Release Notes — this changelog modal, accessible from the navbar.' },
      ...
      { type: 'fixed',    text: 'Avatar initials no longer appear split across a gradient background.' },
